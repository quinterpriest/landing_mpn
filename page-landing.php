...
<section id="top" class="site-wrapper">
    ...
    <a id="bgndVideo" class="player" data-property="{videoURL:'http://youtu.be/rlYVhDKCbqY', containment:'.site-wrapper', autoPlay:true, loop:true, mute:true, startAt:0, stopAt: 50, quality:'small', opacity:1, showControls: false, showYTLogo:false, vol:25}"></a>
            ...
            <div class="inner">
                <h3 class="masthead-brand">
                    <a href="tel:1234567890">
                        ...
                        <small> 
                            <img width="90px" src="<?php echo get_template_directory_uri();?>/images/logo.png" alt="">
                        </small>
                    </a>
                </h3>
                <nav>
